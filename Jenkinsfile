        ...
        stage('Deploy') {
            ...
            steps {
                script {
                    ...
                    sh "sleep 5s"
                    sh "export PYTHONIOENCODING=UTF-8; ${macawPublishCmd} webapp --tag ${dockerImageTag} --name image-manager-webapp --version 1.0.0 --file  ${serviceHome}/webapp/dist/ssaservice.war --skip"
